...
public class StraightComparer {
    ...
    public Boolean blackHandWinnerForStraightCase(PokerHand black, PokerHand white, CardValue value1, CardValue value2) {
        return (comparer.comparer(black, new StraightIdentifier())
                ...
                && !comparer.comparer(white, new FourOfAKindIdentifier(value1, value2))) ? true
                        : flushComparer.blackHandWinnerForFlushCase(black, white, value1, value2);
    }
}
