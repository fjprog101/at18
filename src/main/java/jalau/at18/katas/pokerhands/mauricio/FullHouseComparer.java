...
public class FullHouseComparer {
    ...
    public Boolean blackHandWInnerForFullHouseCase(PokerHand black, PokerHand white, CardValue value1, CardValue value2) {
        return (comparer.comparer(black, new FullHouseIdentifier(value1, value2))
                ...
                && !comparer.comparer(white, new StraightFlushIdentifier())) ? true
                        : fourOfAKindComparer.blackHandWinnerForFourOfAKindCase(black, white, value1, value2);
    }
}
