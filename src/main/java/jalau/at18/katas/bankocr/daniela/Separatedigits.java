 ...
 * return line1.substring(searchminvalue, searchminvalue + SIZEONEDIGIT);
 * }
 * 
 * @Override
 * String hasSameLinesAs2(String line2, int searchminvalue) {
 * return line2.substring(searchminvalue, searchminvalue + SIZEONEDIGIT);
 * }
 * 
 * @Override
 * String hasSameLinesAs3(String line3, int searchminvalue) {
 * return line3.substring(searchminvalue, searchminvalue + SIZEONEDIGIT);
 * }
 * }
 */
