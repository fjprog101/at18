...
public class PointerGroup extends JPanel {
    ...
    public PointerGroup(StackButtonGroup newStackButtonGroup, PyramidBoard newPyramidBoard) {
        this.stackButtonGroup = newStackButtonGroup;
        this.pyramidBoard = newPyramidBoard;
        controller = new StackSenderController(newStackButtonGroup, this, pyramidBoard);
